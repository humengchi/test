...
@implementation ADOilPriceModel
...
-(void)startCallWithArguments:(NSArray *)aArguments{
    ...
    [super startCallWithService:API_OILPRICE_SERVICE
                         method:API_OILPRICE_METHOD
                         ...
                         receivedObject:(NSObject *)object
{
    ...
    [_oilPriceDelegate handleOilPriceData:(NSDictionary*)object];
