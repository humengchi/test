...
- (void)viewDidLoad
{
    ...
    //最后更新时间
    UILabel *labelOfLastUpdatedDate = [[UILabel alloc] initWithFrame:CGRectMake(0, 45, WIDTH, 15)];
    ...
    CGRect rectLine = CGRectMake(0, 68, WIDTH, 2);
...
//    [viewOfBattery addSubview:imageViewOfBattery];
    ...
    //地图
    _mapView = [[BMKMapView alloc] initWithFrame:CGRectMake(0, 145, WIDTH, 115)];
    ...
    _locationLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 240, WIDTH, 20)];
...
//    _locationLabel.alpha=0.75;
    ...
    _alertLabel = [[UILabel alloc]initWithFrame:CGRectMake(5, WIDTH, 150, 30)];
    ...
    _dtcLabel = [[UILabel alloc]initWithFrame:CGRectMake(165, WIDTH, 150, 30)];
