...
@interface ADLoginViewController : ADMenuBaseViewController<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
@property (strong, nonatomic) NSMutableString *trackViewUrl;
